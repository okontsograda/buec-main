      ...
      <body className={inter.className}>
          ...
          <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
            ...
            <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
              <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
                {/* <a className="font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="/"></a>
                <a className="font-medium text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="/ministries">Ministries</a>
                ...
                <a className="font-medium text-gray-500 sm:py-6 animate-pulse hover:animate-none hover:text-white" href="/sundayschool">Sunday School Registration</a>
        ...
        <footer className="mt-auto text-center py-5">
          <div className="text-center">
            <div className="mt-3">
              <p className="text-gray-500 text-sm">© BUEC 2024 All rights reserved.</p>
            </div>

...
import LivePNG from '../media/icons/live.png'

const LiveBanner = () => {
  console.log(LivePNG.src)
  return (
    <div>
        <div className="flex justify-center">
            <Link className="group inline-block bg-white/[.05] hover:bg-white/[.1] border border-white/[.05] p-1 pl-4 rounded-full shadow-md" href="/live">

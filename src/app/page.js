...
export default function Home() {
  ...
  return (
    <main className="h-full">
      ...
      <div class="max-w-[100%] flex flex-col mx-auto h-screen bg-no-repeat bg-cover bg-[url('https://images.pexels.com/photos/69825/sunbeam-fog-autumn-nature-69825.jpeg')]">
        {/* <!-- ========== HEADER ========== --> */}
        <header class="mb-auto flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm py-4">
          <nav class="w-full px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
            <div class="flex items-center justify-between">
              <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">BUEC</a>
              <div class="sm:hidden">
            ...
            <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
              <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                ...
                <a class="font-medium text-gray-400 hover:text-gray-500" href="#">Ministries</a>
                <a class="font-medium text-gray-400 hover:text-gray-500" href="#">About</a>
                <a class="font-medium text-gray-400 hover:text-gray-500" href="#">Contact</a>
              </div>
            </div>
          </nav>
        </header>
        ...
        <main id="content" role="main">
          <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
            <h1 class="block text-2xl font-bold text-white sm:text-4xl">Bethesda Ukrainian Evengelical Church</h1>
            <p class="mt-3 text-lg text-white">"The LORD is my light and my salvation; whom shall I fear? <br />The LORD is the stronghold of my life; of whom shall I be afraid?"</p>
            <div class="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
              ...
              <a class="w-full sm:w-auto inline-flex justify-center items-center gap-x-3.5 text-center border-2 border-white-600 shadow-sm text-sm font-medium rounded-md text-white hover:bg-white hover:text-gray-500 focus:outline-none focus:ring-offset-gray-800 transition py-3 px-4" href="../examples.html">
                Recent Services
              </a>
            </div>
          </div>
      ...
      <footer class="mt-auto text-center py-5">
        <div class="text-center">
          <div class="mt-3">
            <p class="text-gray-500 text-sm">© BUEC 2023 All rights reserved.</p>
          </div>
